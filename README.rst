...
General settings are for easily configurable settings management and output.
...
In systems with load balancers usage, standard symfonys authentication, (which is based on sessions) cannot be used.
Because of that this bundle is offering sessionless authentication functionality. How it works, and how to enable it, `you can read here </Resources/doc/ongr_sessionless_authentication.rst>`_.
