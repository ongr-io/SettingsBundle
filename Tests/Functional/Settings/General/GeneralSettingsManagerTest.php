...
class GeneralSettingsManagerTest extends WebTestCase
{
    /**
     * Create mock array.
     *
    ...
    {
        return self::createClient()->getContainer()->get('ongr_settings.settings.general_settings_manager');
    }

    /**
     * Create mock General settings manager with authorization enabled.
     *
    ...
    public function getManagerWithSecurityMock()
    {
        ...
        $container->register('test.sm', 'ONGR\SettingsBundle\Settings\General\GeneralSettingsManager')
            ->addArgument($scm)
            ->addArgument('b');
